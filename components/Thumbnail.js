  ...
  return (
    ...
    >
      ...
      <div className="p-2">
        ...
        {/* movie title */}
        <h2 className="mb-2 truncate max-w-md text-2xl text-white transition-all duration-100 ease-in-out group-hover:font-bold">
        ...
        <p className="flex items-center opacity-0 group-hover:opacity-100">
          ...
          <DocumentTextIcon className="h-5 mx-2" />{" "}
